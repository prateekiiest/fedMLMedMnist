...
def mnist_iid(dataset1, dataset2):
    ...
    dict_users = {}
    num_items = {}
    num_items[1] = len(dataset1)
    num_items[2] = len(dataset2)
    all_idxs ={}
    all_idxs[1] = [i for i in range(len(dataset1))]
    all_idxs[2] = [i for i in range(len(dataset2))]
...
def oct_noniid(dataset, num_users):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
...
def oct_noniid_unequal(dataset, num_users):
    """
    Sample non-I.I.D client data from MNIST dataset s.t clients
    have unequal amount of data
    :param dataset:
